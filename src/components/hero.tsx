...
const dotField = {
  desktop: { step: 16, dotSize: 1, baseAlpha: 0.03, maxAlpha: 0.16, frameTime: 42 },
  mobile: { step: 20, dotSize: 0.8, baseAlpha: 0.022, maxAlpha: 0.11, frameTime: 50 },
  cleanZoneStrength: 0.68,
};
